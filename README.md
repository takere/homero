...
## 📂 Estrutura do Projeto
  ...
  * `src/gerador.py`: Responsável por gerar o JSON específico de cada tipo de pergunta (com suas propriedades, labels e regras) usando LLM.
...
*Por padrão, o servidor está configurado no código para rodar no `localhost` ou `0.0.0.0`. Você pode ajustar essas configurações no final do arquivo `src/main.py`.*
